function [K_nearest_neighbors, Distances] = Dijkstra_with_early_stopping(IDX,D,s)
%        [Distances, K_nearest_neighbors] = Dijkstra_with_early_stopping(IDX,D,s,k)
% this function implements a dijkstra-like algorithm for finding the k
% nearest neighbors of a source vertex s, with respect to the shortest-path
% distance. Designed to run in a k-nearest neighbors graph
%
% INPUT
% ======================================================================= %
...
% ============ Now perform k iterations of Dijkstra ============== % 
 for i = 1:k
     ...
     for j = 2:k 
         ...
         tempdist = currdist  - Dists_to_neighbors(j);
